...
@section('title', 'Halaman Data Eksklusif')
@section('content')
        <div class="container">
            <div class="card mt-5">
                <div class="card-header text-center">
                    <strong>UPDATE DATA EKSKLUSIF</strong>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('eksklusif.update', $items->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="from-group">
                            <label for="gambar3" class="form-control-label">Gambar3</label>
