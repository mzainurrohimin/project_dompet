        ...
        <div class="container">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('warnadompet.store') }}" enctype="multipart/form-data">
 
                        @csrf
                        <div class="from-group">
                            <label for="warna1" class="form-control-label">Varian1</label>
                            <input type="text" name="warna1" value="{{ old('warna1') }}" class="form-control @error('warna1') is-invalid @enderror"/>
                        ...
                        <div class="from-group">
                            ...
                            <input type="text" name="warna2" value="{{ old('warna2') }}" class="form-control @error('warna2') is-invalid @enderror"/>
